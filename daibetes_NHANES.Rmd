...
After adjusting multiple factors such as age, BMI, physical activity, race, education, poverty, depression and gender, individuals with sleep trouble show a higher probability of having Type II diabetes. The predicted probability increases from 8.7% to 14.2%, suggesting a moderate but meaningful association. These findings align with prior research linking sleep disorders with metabolic dysregulation and diabetes risk(Cappuccio et al., 2010; Darraj, 2023). 
